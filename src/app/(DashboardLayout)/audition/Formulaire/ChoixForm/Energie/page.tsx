  ...
  const router=useRouter();
            ...
            const handleSubmit =async (event:any)=> {
                ...
                hcPourcent=hcPourcent/total
                 ...
                 const energieData = {
                    audit:cookies.id,
                    Qte_kwh:qteKwh.toFixed(2),
                    Prix_HPE_kwh:prixhpeKwh.toFixed(2),
                    Prix_HCE_kwh:prixhceKwh.toFixed(2),
                    Prix_HPH_kwh:prixhphKwh.toFixed(2),
                    Prix_HCH_kwh:prixhchKwh.toFixed(2),
                    Prix_Acheminement:prixAcheminement.toFixed(2),
                    Taxes:taxes.toFixed(2),
                    Abonnement:abonnement.toFixed(2),
                    Pourcent_HP:hpPourcent.toFixed(2),
                    Pourcent_HC:hcPourcent.toFixed(2),
                    Totale:totalFixe,
                    Mois:mois
                };
